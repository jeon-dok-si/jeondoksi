...
const PERSONALITY_TYPES = {
    ...
    THINKER: {
        title: '논리적인 사색가',
        desc: '논리적인 사고와 깊은 사색의 균형을 완벽하게 갖추었습니다. 체계적으로 지식을 습득하고 정리하는 것을 즐기며, 다양한 분야의 책을 통해 자신만의 견고한 지식 체계를 구축해 나가는 당신은, 끊임없이 배우고 탐구하는 학구적인 독자입니다.',
        icon: '🧠',
        tags: ['#체계적', '#지식탐구', '#논리정연', '#학구열']
    },
    DOER: {
        title: '적극적인 행동파',
        desc: '독서를 통해 얻은 에너지와 영감을 바탕으로 새로운 도전을 두려워하지 않습니다. 책 속의 아이디어를 현실로 구현해내는 추진력을 가진 당신은, 독서를 삶의 원동력으로 삼아 역동적인 인생을 개척해 나가는 모험가입니다.',
        icon: '🔥',
        tags: ['#에너지', '#적극성', '#도전', '#추진력']
    },
    BALANCED: {
        title: '균형잡힌 독자',
        desc: '이성적인 판단과 감성적인 공감, 그리고 실천적인 행동까지 모든 면에서 조화를 이룹니다. 편식하지 않고 다양한 장르의 책을 즐기며, 독서를 통해 삶의 균형을 찾아가는 당신은, 가장 이상적이고 성숙한 독서 습관을 가진 현명한 독자입니다.',
        icon: '⚖️',
        tags: ['#조화', '#다방면', '#균형', '#이상적']
    },
    READER: {
